...
class LicenciasTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('TipoOrigen', [
            'className' => 'TipoOrigenesLicencia',
            'foreignKey' => 'tipo_origen_licencia_id',
            'joinType' => 'LEFT',
            'propertyName' => 'tipo_origen'
        ]);
        $this->belongsTo('Divisiones', [
            // 'className' => 'Divisiones',
            'foreignKey' => 'division',
            'joinType' => 'INNER',
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        // $rules->add($rules->existsIn(['tipo_origen_licencia_id'], 'TiposOrigenLicencia'));
        ...
        $rules->add($rules->existsIn(['division'], 'Divisiones'));
        return $rules;
    }
