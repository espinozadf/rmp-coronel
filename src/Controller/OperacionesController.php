...
class OperacionesController extends AppController {
  ...
  public function isAuthorized($user = null)
  {
    ...
    switch ($this->request->action) {
        case 'index':
        case 'comprobarNuevaOperacion':
        case 'obtenerTotalPorEspecie':

        $search = 'cuotas_operacion';
  ...
  public function index(){
     ...
     */
        ...
        $operaciones = $this->Operaciones->find('all',[ 'conditions' => ['Licencias.division IN' => $divisionUsuario]])
        ->contain([
