            ...
            dataColumns: [
                {
                    ...
                    "data": function (row) {
                        return row.cantidad?'<input type="hidden" name="unidad_id" value="1"><input type="hidden" name="cantidad" value="'+toggleNumberFormat(row.cantidad)+'"/>'+toggleNumberFormat(row.cantidad):null;
                    },
                }, {
                ...
                $.each(lines, function(i, line) {
                    ...
                    .always(function (data) {
                        ...
                        var tmp_data = {
                          ...
                          cantidad: toggleNumberFormat(cargaCantidad),
