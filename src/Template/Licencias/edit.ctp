...
<div class="row" id="<?=$hash_id?>">
    ...
    <div class="col-md-12">
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control input-xs" name="tipo_licencia_id" id="tipo-licencia-id" data-placeholder="Seleccione un Tipo de Licencia" lang="es" style="width: 100%;">
                                <option value="<?=$licencia->tipo_licencia_id?>" selected><?=$licencia->tipo_licencia->abreviacion?></option>
                            </select>
                        </div>
                    </div>
                </div>
                <div id="division-div" class="col-xs-12">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">División</label>
                        <div class="col-sm-9">
                            <div class="">
                                <select class="form-control input-xs" name="divisiones_id" id="divisiones-id" data-placeholder="Seleccione una División" lang="es" style="width: 100%;">
                                <option value="<?=$licencia->divisione->id?>" selected><?=$licencia->divisione->nombre?></option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Origen Licencia</label>
                        <div class="col-sm-9">
                            <select class="form-control input-xs" name="tipo_origen_licencia_id" id="tipo-origen-licencia-id" data-placeholder="Seleccione un Origen de Licencia" lang="es" style="width: 100%;">
                                <option value="<?=$licencia->tipo_origen_licencia_id?>" selected><?=$licencia->tipo_origen?$licencia->tipo_origen->nombre:''?></option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control input-xs" name="modifica_licencia_id" id="modifica-licencia-id" data-placeholder="Seleccione una Licencia" lang="es"  style="width: 100%;">
                                <?php if (!empty($licencia->modifica_licencia_id)): ?>
                                    <option value="<?=$licencia->modifica_licencia_id?>" selected><?=$licencia->modifica_licencia->codigo_resolucion?></option>
                                <?php endif; ?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="codigo_resolucion" id="codigo-resolucion" type="text" class="form-control input-xs" placeholder="Ingrese el Código de Resolución" value="<?=$licencia->codigo_resolucion?>">
                        </div>
                    </div>
                </div>
                <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group input-group-xs date-picker" id="fecha-promulgacion-date-container">
                                ...
                                <input name="fecha_promulgacion" value ="<?=$licencia->fecha_promulgacion?>" id="fecha-promulgacion-date" type="text" class="form-control" placeholder="Ingrese Fecha de Promulgación" >
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <select class="form-control input-xs" name="auxiliar_id" id="auxiliar-id" data-placeholder="Seleccione al Titular de la Licencia" lang="es" style="width: 100%;">
                                    <option value="<?=$licencia->auxiliar_id?>" selected><?=$licencia->auxiliar->nombre_completo?></option>
                                </select>
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <select class="form-control input-xs" name="nave_id" id="nave-id" data-placeholder="Seleccione la Nave Titular" lang="es" style="width: 100%;">
                                    <?php if (!empty($licencia->nave_id)): ?>
                                        <option value="<?$licencia->nave->id?>"><?=$licencia->nave->nombre?></option>
                                    <?php else: ?>
                                        <option value=""></option>
                                    <?php endif; ?>
                                </select>
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <select class="form-control input-xs" name="especie_id" id="especie-id" data-placeholder="Seleccione una Especie" lang="es" style="width: 100%;">
                                    <option value="<?=$licencia->especie_id?>" selected><?=$licencia->especie->nombre?></option>
                                </select>
                                <div class="input-group-btn">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                ...
                                <select class="form-control input-xs" name="macro_zonas[_ids][]" id="macro-zonas-ids" data-placeholder="Seleccione las Macro Zonas" lang="es" multiple="multiple">
                                    <?php foreach($licencia->macro_zonas as $macro_zona): ?>
                                        <option value="<?=$macro_zona->id?>" selected><?=$macro_zona->nombre?></option>
                                    <?php endforeach; ?>
                                </select>
                                <div class="input-group-btn">
                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="row">
                                <div class="col-sm-9">
                                    <input id="costo" type="text" name="costo" class="form-control input-xs" placeholder="Ingrese el costo de la licencia." style="text-align: right;" value="<?=$this->Number->precision($licencia->costo, 6)?>">
                                </div>
                                <div class="col-sm-3">
                                    <select id="costo-unidad-id" name="costo_unidad_id" data-placeholder="Divisa" placeholder="Seleccione la moneda" lang="es" style="width: 100%;" class="form-control input-xs">
                                        ...
                                        <?php foreach ($monedas as $moneda): ?>
                                            <option value="<?=$moneda->id?>"<?=$moneda->id==$licencia->costo_unidad_id?' selected="selected"':''?>><?=$moneda->abreviacion?></option>
                                        <?php endforeach;?>
                                    </select>
                                </div>
                            </div>
                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control input-xs" id="adjunto-text-container" readonly="" placeholder="Seleccione un archivo" value="<?=$licencia->adjunto?>">
                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" name="observaciones" id="observaciones"><?=$licencia->observaciones?></textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="input-container">
                          <input name="unidades[0][_joinData][cantidad]" id="porcentaje" type="text"
                              class="form-control input-xs" placeholder="Ingrese el Porcentaje"
                              value="<?=$this->Number->precision($licencia->porcentaje, 6)?>">
                          <label>%</label>
                        </div>
                    </div>
                </div>
    ...
    <div id="numeracion-div">
        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-container">
                      <input type="text" id="umr-total" class="form-control input-xs" placeholder="UMR" name="unidades[2][_joinData][cantidad]" value="<?=$this->Number->precision($licencia->umr, 7)?>"/>
                      <label for="">UMR</label>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12" id="numeraciones-div" style="padding-top: 5px;">
            <?php foreach($licencia->numeraciones as $idx => $numeracion): ?>
            <div class="row" role="numeracion-row">
                <div class="col-md-5">
                    <input class="form-control input-xs inicio" name="numeraciones[<?=$idx?>][inicio]" placeholder="Inicio" value="<?=$numeracion->inicio?>"/>
                </div>
                <div class="col-md-5">
                    <input class="form-control input-xs fin" name="numeraciones[<?=$idx?>][fin]" placeholder="Fin" value="<?=$numeracion->fin?>"/>
                </div>
                <div class="col-md-2">
                    <button class="btn btn-danger delete-numeracion-btn btn-26"><i class="fa fa-trash"></i></button>
                </div>
            </div>
            <?php endforeach; ?>
        </div>
...
<script>
  $(document).ready(function () {
    ...
    <?php if ($licencia->tipo_licencia_id == 3):?> //PEP
    ...
    $('#tipo-licencia-id', $thisModal).select2();
    <?php if($licencia->tipo_licencia_id == 4 || $licencia->tipo_licencia_id == 34): ?> //RAE
    $('#nave-titular-div', $thisModal).show();
    $('#nave-id').prop('disabled', false);
    $('#nave-id').select2({
        dropdownParent: $thisModal,
    });
    setTimeout(function () {
        $('#tipo-licencia-id', $thisModal).trigger('change');
    }, 1000);
    <?php endif; ?>

    // $('#tipo-licencia-id', $thisModal).on('change', function() {
    //     if (($(this).val() == 3) || ($(this).val() == 34) || ($(this).val() == 4)) { //PEP RAE EXCEP
    //         $('#numeracion-div', $thisModal).hide();
    //         $('#numeracion-div input', $thisModal).prop('disabled', true);
    //     } else {
    ...
    //         $('#nave-id').data('placeholder', 'Cargando ...');
    //         $('#nave-id').select2({
    //             dropdownParent: $thisModal
    //         });
    ...
    //                 <?php if ($licencia->nave_id):?>
    //                 if (nave.id != <?=$licencia->nave_id?>) {
    //                 <?php endif; ?>
    //                     naves.push({id: nave.id, text: nave.nombre});
    //             }
    //         });
    //             $('#nave-id').data('placeholder', 'Seleccione la Nave Titular');
    //             $('#nave-id').select2({
    //                 dropdownParent: $thisModal,
    //                 data: naves
    //             })
    ...
    // TIPO ORIGENES LICENCIA
    tipo_origenes_licencia = []
    $.ajax({
        url: '/api/tipo_origenes_licencia.json',
        type: 'GET',
        dataType: 'json'
    })
    .done(function (data) {
        $.each(data.tipo_origenes_licencia, function (i, val) {
            tipo_origenes_licencia.push({id: i, text: val});
        });
        $('#tipo-origen-licencia-id', $thisModal).select2({
            data: tipo_origenes_licencia,
            dropdownParent: $thisModal
        });
    });
    $('#tipo-origen-licencia-id', $thisModal).select2();
    // FIN TIPO ORIGENES LICENCIA
    ...
    $('#fecha-promulgacion-date', $thisModal).val( moment.utc('<?=$licencia->fecha_promulgacion->format(DateTime::ISO8601)?>').format('DD-MMM-YYYY') )
    $('#fecha-promulgacion-date-container', $thisModal).datetimepicker(dateOptions(false, moment()));
    $('#fecha-inicio-date', $thisModal).val( moment.utc('<?=$licencia->fecha_inicio_vigencia->format(DateTime::ISO8601)?>').format('DD-MMM-YYYY') )
    $('#fecha-inicio-date-container', $thisModal).datetimepicker(dateOptions(false));
    $('#fecha-termino-date', $thisModal).val( moment.utc('<?=$licencia->fecha_termino_vigencia->format(DateTime::ISO8601)?>').format('DD-MMM-YYYY') )
    ...
    /** Manejo de UMD **/
    idx_num = <?=count($licencia->numeraciones)?>;
    $('#add-numeracion-btn', $thisModal).on('click', function (e){
        ...
        tmp_html += '<button class="btn btn-danger delete-numeracion-btn"><i class="fa fa-trash"></i></button>';
        tmp_html += '</div></div>';
    ...
    function updateUMD() {
        ...
        $('#numeraciones-div .row', $thisModal).each(function(i, e) {
            var $thisRow = $(this);
            var cantidad_inicio = $('input[name$="[inicio]"]', $thisRow).val() - 1;
            var cantidad_fin = $('input[name$="[fin]"]', $thisRow).val();

            umd_total += cantidad_fin - cantidad_inicio;
        });
