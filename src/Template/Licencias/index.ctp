    ...
    dataColumns: [
      {
        ...
        "class": "centered",
        "data": function(row) {return row.adjunto?'<a href="/uploads/'+row.adjunto+'" target="_blank" class="btn" title="Descargar documento adjunto"><i class="fa fa-download"></i></a>':'<button disabled="disabled" class="btn btn-disabled" title="Documento adjunto no disponible"><i class="fa fa-download"></i></button>';}
      }
    ],
