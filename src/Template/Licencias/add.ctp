            ...
            <div class="row">
                ...
                <div id="division-div" class="col-xs-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="">
                                <select class="form-control input-xs" name="division" id="division" data-placeholder="Seleccione una División" lang="es" style="width: 100%;">
                                    <option value></option>
                                </select>
                            </div>
                        </div>
...
<script>
 ...
 divisiones = []
        $.ajax({
            url: '/api/divisiones.json',
            type: 'GET',
            dataType: 'json'
        })
        .done(function (data) {
            $.each(data.divisiones, function (i, val) {
                divisiones.push({id: i, text: val});
            });
            $('#division', $thisModal).select2({
                data: divisiones,
                dropdownParent: $thisModal
            });
        });
    ...
    $('#fecha-promulgacion-date-container', $thisModal).datetimepicker(dateOptions(false));
