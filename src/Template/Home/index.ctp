        ...
        <div class="row">
          <div class="col-lg-6 col-sm-6 col-xs-12">
            ...
            <div class="main-menu-group">
              ...
              <?php endif; ?>
              <?php if(array_in_array(['cuotas'], $modulos)): ?>
              <p><?= $this->Html->link('Asignación de Descargas', ['controller' => 'Asignaciones', 'action' => 'index'], ['class' => 'btn btn-lg btn-block'])?></p>
              <?php else: ?>
              <p><?= $this->Html->link('Asignación de Descargas',['controller' => 'Asignaciones', 'action' => 'index'],['class' => 'btn btn-lg btn-block', 'disabled' => 'disabled']) ?></p>
              <?php endif; ?>
            </div>
          </div>
          <div class="col-lg-6 col-sm-6 col-xs-12">
              ...
              <div class="tab-content">
                ...
                <div id="admin-mantencion-tab" class="tab-pane">
                    <p>
                      ...
                      <?php if (array_in_array(['tcs'], $modulos)): ?>
                      <?= $this->Html->link('TCS', ['controller' => 'Tcs', 'action' => 'index'], ['class' => 'btn btn-lg btn-halfblock']) ?>
                      <?php else: ?>
                        <?= $this->Html->link('TCS', ['controller' => 'Tcs', 'action' => 'index'], ['class' => 'btn btn-lg btn-halfblock', 'disabled' => 'disabled']) ?>
                      <?php endif; ?>
