...
Router::scope('/api', function ($routes) {
    ...
    //tcs
    $routes->connect('/tcs', ['controller' => 'Tcs', 'action' => 'listar']);
  //   $routes->connect('/tcs/:estado', ['controller' => 'Tcs', 'action' => 'listar'], [
  //     'pass' => ['estado']
  // ]);
    // arte pesca
    ...
    // $routes->connect('/asignaciones', ['controller' => 'Asignaciones', 'action' => 'index']);
    $routes->connect('/asignaciones/listarDescargas', ['controller' => 'Asignaciones', 'action' => 'listarDescargas']);
    $routes->connect('/asignaciones/listarOperaciones', ['controller' => 'Asignaciones', 'action' => 'listarOperaciones']);
    $routes->connect('/asignaciones/listarAsignaciones', ['controller' => 'Asignaciones', 'action' => 'listarAsignaciones']);
    $routes->connect('/asignaciones/asignar', ['controller' => 'Asignaciones', 'action' => 'asignar']);
    $routes->connect('/asignaciones/add', ['controller' => 'Asignaciones', 'action' => 'add']);
    $routes->connect('/asignaciones/addSinControlCuota', ['controller' => 'Asignaciones', 'action' => 'addSinControlCuota']);
    $routes->connect('/asignaciones/addDescarguita', ['controller' => 'Asignaciones', 'action' => 'addDescarguita']);
    $routes->connect('/asignaciones/addBolson', ['controller' => 'Asignaciones', 'action' => 'addBolson']);
    $routes->connect('/asignaciones/addCuentaCorriente', ['controller' => 'Asignaciones', 'action' => 'addCuentaCorriente']);
    $routes->connect('/asignaciones/obtenerTonDescargas', ['controller' => 'Asignaciones', 'action' => 'obtenerTonDescargas']);
    $routes->connect('/asignaciones/addDescargaParcial', ['controller' => 'Asignaciones', 'action' => 'addDescargaParcial']);
    $routes->connect('/asignaciones/addDaJurel', ['controller' => 'Asignaciones', 'action' => 'addDaJurel']);
    ...
    $routes->resources('Divisiones', [
      'only' => ['index']
  ]);
    $routes->resources('TipoOrigenesLicencia', [
        'only' => ['index']
    ]);
    $routes->resources('Auxiliares', [
        'only' => ['index']
