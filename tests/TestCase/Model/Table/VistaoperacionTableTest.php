...
use App\Model\Table\VistaoperacionTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\VistaoperacionTable Test Case
 */
class VistaoperacionTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\VistaoperacionTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Vistaoperacion') ? [] : ['className' => 'App\Model\Table\VistaoperacionTable'];
        $this->Vistaoperacion = TableRegistry::get('Vistaoperacion', $config);
    }
