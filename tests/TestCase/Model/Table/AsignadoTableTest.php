...
use App\Model\Table\AsignadoTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\AsignadoTable Test Case
 */
class AsignadoTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\AsignadoTable
     */
    public $Asignado;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Asignado') ? [] : ['className' => 'App\Model\Table\AsignadoTable'];
        $this->Asignado = TableRegistry::get('Asignado', $config);
    }
